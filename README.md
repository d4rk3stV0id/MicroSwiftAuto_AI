...
Key Goals:
.// Digitize: Convert handwritten/printed rural clinic forms into structured data.
.// Triage: Automatically categorize claims into Green (Auto-approve), Yellow (Manual Review), or Red (Flagged/Rejected).
.// Scale: Provide a low-bandwidth, mobile-friendly interface for clinic staff.
